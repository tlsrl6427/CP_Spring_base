...
public class Archer extends CharacterVo {
   ...
   public void active_skill6(MopVo mopVo, AttackVo attack_mop_vo) {
      ...
      attack_mop_vo.setBattle_info(String.format("%s(이)가 영문도 모르고 자신을 공격하여 %s(으)로 %d의 피해를 입혔습니다.", 
                                                         mopVo.getM_name(), 
                                                         attack_mop_vo.getName(),
                                                         mopVo.getM_ad() * (5000 / ( 50 + mopVo.getM_armor() ) ) / 100));
   }
   ...
   public void active_skill7(MopVo mopVo, AttackVo attack_mop_vo) {
      ...
      attack_mop_vo.setBattle_info(String.format("%s(이)의 회피율이 %d만큼 상승하고, 크리티컬 확률이 %d만큼 상승하였습니다.", 
                                                         this.getC_name(), 
                                                         this.getC_avd(),
                                                         this.getC_critical()));
   }
   ...
   public void active_skill8(MopVo mopVo, AttackVo attack_mop_vo) {
      ...
      attack_mop_vo.setBattle_info(String.format("%s(이)의 기본 공격력이 %d으로 상승하였습니다.", 
                                                this.getC_name(), 
                                                ad_increased
                                                ));
   }
