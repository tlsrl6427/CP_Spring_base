				...
				<div id="game_page"
					...
					<div>
						<div id="guard_info" style="margin-top: 50px; margin-left: 10px;">
							<table border="1" style="margin: 5px;">
								<tr>
									<td id="items">머리방어구</td>
								</tr>
								<tr>
									<td id="items">상체방어구</td>
								</tr>
								<tr>
									<td id="items">하체방어구</td>
								</tr>
								<tr>
									<td id="items">무기</td>
								</tr>
					...
					<div id="user_hp_bar">
						<div>
							...
							<img id="warrior"
								src="${ pageContext.request.contextPath }/resources/img/warrior.png">
						</div>
					</div>
					...
					<div id="mop_hp_bar">
						<div>
							...
							<img id="warrior1"
								src="${ pageContext.request.contextPath }/resources/img/wizard.png">
						</div>
					</div>
				</div>
					...
					<div id="state_page">
						...
						<div id="btn_state">
							<a onclick="aa();"><img id="btn_skill1"
								src="${ pageContext.request.contextPath }/resources/img/general.png"></a>
							<a onclick="shop();"><img id="btn_skill2"
								src="${ pageContext.request.contextPath }/resources/img/shop.png"></a>
