				...
				<table border="2">
					...
					<tr>
						<td colspan="10" id="skill_check">
							<div id="skill_left">
								<input id="skill" type="checkbox" name="${ main_ch.skill_vo[0].s_num }" value="${ main_ch.skill_vo[0].s_idx }">${ main_ch.skill_vo[0].s_name }
								<input type="number" id="skill_no" name="skill_no" min="0" max="10" value="0"><br><br>
								
								<input id="skill" type="checkbox" name="${ main_ch.skill_vo[2].s_num }" value="${ main_ch.skill_vo[2].s_idx }">${ main_ch.skill_vo[2].s_name }
								<input type="number" id="skill_no" name="skill_no" min="0" max="10" value="0"><br><br>
								
								<input id="skill" type="checkbox" name="${ main_ch.skill_vo[4].s_num }" value="${ main_ch.skill_vo[4].s_idx }">${ main_ch.skill_vo[4].s_name }
								<input type="number" id="skill_no" name="skill_no" min="0" max="10" value="0"><br><br>
								
								<input id="skill" type="checkbox" name="${ main_ch.skill_vo[6].s_num }" value="${ main_ch.skill_vo[6].s_idx }">${ main_ch.skill_vo[6].s_name }
								<input type="number" id="skill_no" name="skill_no" min="0" max="10" value="0"><br><br>
							</div>
