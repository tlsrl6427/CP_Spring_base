...
<!--------------------------------------------------------------------------------------------------------------------------->
					<tr id="inventory">
                     <c:if test="${ not empty main_ch.item_list[0].i_name }">
                        <td id="helmet" class="tooltip">${ main_ch.item_list[0].i_name }
                     ...
                     <c:if test="${ not empty main_ch.item_list[1].i_name }">
                        <td id="upper_body" class="tooltip">${ main_ch.item_list[1].i_name }
                        <span class="tooltiptext">
                        <ul>
                     ...
                     <c:if test="${ not empty main_ch.item_list[2].i_name }">
                        <td id="lower_body" class="tooltip">${ main_ch.item_list[2].i_name }
                        <span class="tooltiptext">
                        <ul>
                     ...
                     <c:if test="${ not empty main_ch.item_list[3].i_name }">
                        <td id="weapon" class="tooltip">${ main_ch.item_list[3].i_name }
                        <span class="tooltiptext">
                        <ul>
